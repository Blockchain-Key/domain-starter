...
const tld = '.gear';
const CONTRACT_ADDRESS = '0x9F925d589d54738bdb906Aa2cF7008304FE00d5d';
...
const App = () => {
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img src="https://media.giphy.com/media/3ohhwytHcusSCXXOUg/giphy.gif" alt="Gear gif" />
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">🐱‍👤 Gear Name Service</p>
